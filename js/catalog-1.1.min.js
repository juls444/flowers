        ...
        var m = function r() {
            ...
            y = function e(r) {
                if (window.tStoreFilters || (window.tStoreFilters = {}), r && (r.filters && r.filters.length > 0 || r.search || r.sort)) {
                    ...
                    var o = "tilda-catalog-filters-1.0";
                    if (document.head.querySelector('script[src*="' + o + '"]')) t_store_onFuncLoad("t_store_filters_init", (function () {
                        v()
                    }));
                    else {
                        var i = document.createElement("script");
                        i.type = "text/javascript", i.src = "https://static.tildacdn.com/js/" + o + ".min.js", i.onload = v, i.onerror = function () {
                            console.error("Failed to load tilda-catalog-filters: ", this.src), m()
                        }, document.head.appendChild(i)
                    }
                    if (!document.head.querySelector('link[href*="' + o + '"]')) {
                        var s = document.createElement("link");
                        s.rel = "stylesheet", s.type = "text/css", s.href = "https://static.tildacdn.com/css/" + o + ".min.css", s.media = "all", document.head.appendChild(s)
                    }
                } else m()
            };
...
function t_store_snippet_initProduct(t, e, r) {
    ...
    if (l && "none" !== l.style.display && l.insertAdjacentHTML("beforebegin", window.tStoreDict.sku + ": "), i.setAttribute("data-product-gen-uid", r.uid), i.setAttribute("data-product-part-uid", r.partuids ? r.partuids.join(",") : ""), e.tabs) {
        ...
        if (document.head.querySelector('script[src*="' + p + '"]')) t_onFuncLoad("t_store_tabs_initSnippet", (function () {
            ...
            _.type = "text/javascript", _.src = "https://static.tildacdn.com/js/" + p + ".min.js", _.onload = function () {
        ...
        if (!document.head.querySelector('link[href*="' + p + '"]')) {
            ...
            u.rel = "stylesheet", u.type = "text/css", u.href = "https://static.tildacdn.com/css/" + p + ".min.css", u.media = "all", document.head.appendChild(u)
        }
...
function t_store_hoverZoom_init(t) {
    var e = "https://static.tildacdn.com/js/tilda-hover-zoom-1.0.min.js",
        r;
    ...
    if (c) {
        ...
        if (!r.isPublishedPage) {
            var m = window.location.hostname.split("."),
                v = "tilda." + m[m.length - 1];
            _.projectid = document.getElementById("allrecords").getAttribute("data-tilda-project-id"), g = "https://" + v + "/projects/store" + (s ? "/getrelevantproducts/" : "/getproductslist/")
        }
        var y = Date.now();
            ...
            if (f.readyState === f.DONE && 200 === f.status) {
                ...
                if (_.options && _.options.length >= 1 && (window.tStoreOptionsList = _.options), t_store_process(u, e, r, !!o, s, _), _.parts && _.parts.length > 1 && !c.querySelector(".js-store-parts-switcher") && !r.hideStoreParts) {
                    var g = function t() {
                        ...
                        m = "tilda-catalog-filters-1.0";
                    if (document.head.querySelector('script[src*="' + m + '"]')) g();
                    else {
                        var v = document.createElement("script");
                        v.type = "text/javascript", v.src = "https://static.tildacdn.com/js/" + m + ".min.js", v.onload = g, v.onerror = function () {
                            console.error("Failed to load tilda-catalog-filters: ", this.src)
                        }, document.head.appendChild(v)
                    }
                    if (!document.head.querySelector('link[href*="' + m + '"]')) {
                        var y = document.createElement("link");
                        y.rel = "stylesheet", y.type = "text/css", y.href = "https://static.tildacdn.com/css/" + m + ".min.css", y.media = "all", document.head.appendChild(y)
                    }
                }
    ...
    if (a) {
        ...
        if (n) {
            ...
            if (Array.prototype.forEach.call(t, (function (t) {
                ...
                var U, R = a.querySelector(".js-store-tpl-slider-arrows").innerHTML;
                if (O += "</div>", O += "</div>", R && !i && d && (O += R, n.classList.remove("t-container"), n.classList.remove("t-store__grid-cont_mobile-grid")), !i && d) {
...
function t_store_get_productCard_html(t, e, r, o, i, s) {
    ...
    var k = e.url || "",
        P = "";
    m && ("2" === r.prodCard.style ? P += " t-store__card_in-row" : "3" === r.prodCard.style ? P += " t-store__card_under-description" : P += " t-store__card_in-column", P += r.prodCard.hasSeparator ? "" : " t-store__card_no-separator", P += parseInt(r.rightColumnWidth, 10) ? " t-store__card_fixed-width" : "", P += r.verticalAlign ? " t-store__card_verticalAlign_" + r.verticalAlign : "");
    var L = [];
    try {
...
function t_store_get_productCard_img_html(t, e, r) {
    ...
    if ("" !== (g = g.replace(/&amp;amp;/, "&amp;"))) {
        ...
        if (1 === t.editions.length) {
            var v = t_store_product_getFirstAvailableEditionData(t.editions);
            v.uid && u.setAttribute(e.hasOriginalAspectRatio ? "imgfield" : "bgimgfield", "st_gallery__" + v.uid + ":::0")
        }
...
function t_store_get_productCard_imgElHover_html(t, e, r) {
    if (t.gallery && "[" === t.gallery[0]) {
        ...
        if (void 0 !== o[1]) {
            ...
            else(s = document.createElement("div")).classList.add("t-store__card__bgimg_second"), s.classList.add("t-bgimg"), s.setAttribute("data-original", i), s.style.backgroundImage = 'url("' + t_store_getLazyUrl(e, i) + '")', t_store_get_productCard_getImgStyles(s, e);
            return s.outerHTML
        }
    }
    return ""
...
function t_store_get_productCard_onePrice_html(t, e, r, o) {
    ...
    p = "" !== _ ? 'style = "' + _ + '"' : "";
    var m = 1 === t.editions.length && e.uid ? 'field="st_' + d + "__" + e.uid + '" data-redactor-toolbar="no"' : "",
        v = r.currencyTxt ? '<div class="t-store__card__price-currency" translate="no">' + r.currencyTxt + "</div>" : "",
    ...
    if (n && (y += " js-store-prod-price-range-val"), c += '<div class="' + l + " t-store__card__price-item t-name t-name_" + ("1025" === r.prodCard.blockId ? "md" : "xs") + '" ' + p + ">", n && "from" === a) {
        c += '<div class="t-store__card__price-from t-store__card__price-value" translate="no" ' + m + ">" + window.tStoreDict.from + "</div>";
        var h = t_store__getFormattedMinPrice(r, t);
        null !== h && (s = h)
    }
    return c += "r" !== r.currencySide && v ? v : "", c += '<div class="' + y + ' t-store__card__price-value" translate="no" ' + m + ">" + s + "</div>", c += "r" === r.currencySide && v ? v : "", t.unit && t.portion > 0 && (c += '<div class="t-store__prod__price-portion"><span class="t-store__prod__price-portion-slash">/</span>', "1" !== t.portion && (c += +t.portion + " "), c += window.tStoreDict[t.unit] + "</div>"), c += "</div>"
}
...
function t_store_initPopup(t, e, r, o, i) {
    if (!o) try {
        window.sessionStorage.setItem("urlBeforePopupOpen", window.location.href), window.sessionStorage.setItem("titleBeforePopupOpen", document.title)
    } catch (l) {
        console.log(l)
    }
        ...
        if ("list" === r.showStoreBtnQuantity && t.classList.contains("t-store__card") || "popup" === r.showStoreBtnQuantity && t.classList.contains("t-store__product-snippet") || "popup" === r.showStoreBtnQuantity && t.classList.contains("t-store__product-popup") || "both" === r.showStoreBtnQuantity) {
            ...
            if (a) {
                ...
                if (t.classList.contains("t-store__card") && (g = "", "sm" === r.btnSize && (g = "t-store__prod__quantity_xs")), "" !== _ && _) {
                    var m = _.indexOf("border-radius");
                    if (-1 !== m) {
                        var v = _.slice(m).indexOf(";");
                        u = _.slice(m + 14, m + v)
                    }
                }
                var y = "";
...
function t_store_initTextAndCharacteristics(t, e) {
    ...
    if (_ && e.characteristics.forEach((function (t) {
        ...
        })), w += '<p class="js-store-prod-dimensions t-typography__characteristics"></p>', h += w += '<p class="js-store-prod-weight t-typography__characteristics"></p>', h += "</div>", o && (o.insertAdjacentHTML("beforeend", y), o.insertAdjacentHTML("beforeend", h), o.style.display = ""), r && v.length && Array.prototype.forEach.call(v, (function (t, e) {
    ...
    if (a) {
        ...
        for (var S = 0; S < r.values.length; S++) {
            ...
            if ("" !== (f = r.values[S])) {
                ...
                s += '<span class="t-product__option-title ' + m + ' t-typography__options t-descr t-descr_xxs">' + f + "</span>", s += "</label>"
            }
        }
...
function t_store_closePopup(t, e, r) {
    ...
    var m = document.querySelector(".t-popup");
    setTimeout((function () {
        m.scrollTop = 0, Array.prototype.forEach.call(document.querySelectorAll(".t-popup:not(.t-popup_show)"), (function (t) {
            t.style.display = "none"
        }))
    }), 300), document.removeEventListener("keydown", t_store_closePopupKeyDown), window.removeEventListener("resize", window.t_store_prodPopup_updateGalleryThumbsEvent), t_store_triggerEvent(document.body, "twishlist_addbtn"), t_store_triggerEvent(m, t_store_POPUP_CLOSED_EVENT_NAME)
}
...
function t_store_drawProdPopup_drawGallery(t, e, r, o) {
    var i = 980,
        s = "https://static.tildacdn.com/js/tilda-catalog-slds-1.0.min.js";
                    ...
                    Array.prototype.forEach.call(o, (function (t, e) {
                        ...
                        if (d += i.replace("[[activeClass]]", 0 === e ? "t-slds__item_active" : "").replace("[[productClass]]", 0 === e ? "js-product-img" : "").replace(/\[\[index\]\]/g, e + 1).replace(/\[\[imgsource_lazy\]\]/g, t_store_getLazyUrl(r, t.img)).replace(/\[\[imgsource\]\]/g, t.img).replace(/\[\[imgalttext\]\]/g, t_store_escapeQuote(t.alt)), l)
                            if (p && "l" === r.sliderthumbsside) {
                                var s = t_store_prodPopup_gallery_calcMaxThumbsCount(_, u, g, m);
    ...
    if (t) {
        ...
        if (c) {
            var l = c.baseUrl,
                ...
                u = void 0 === _ ? "" : _,
                g, m;
            return a && p.push(a), v(l + "?" + p.filter((function (t) {
                return t
            })).join("&") + u)
        }
    }
...
function t_store_product_updateEdition_moveSlider(t, e, r) {
    if (e && r && r.img) {
        ...
        if (o) {
            ...
            if (!d && -1 !== a.indexOf(".com")) {
                var c = a.split("https://static.tildacdn.com");
                if (2 === c.length) {
                    var l = e.querySelector('.t-slds__item .t-slds__bgimg[data-original$="' + c[1] + '"]');
...
function t_store_product_sortValues(t, e, r) {
    ...
    var i = "filter" === e ? t[0].value.toString() : t[0].toString(),
        ...
        a = ["XXXS", "3XS", "XXS", "2XS", "XS", "XS-S", "S", "S-M", "M", "M-L", "L", "L-XL", "XL", "XXL", "2XL", "XXXL", "3XL", "XXXXL", "BXL", "4XL", "BXXL", "5XL", "BXXXL", "6XL", "ONE SIZE", "ОДИН РАЗМЕР", "УНИВЕРСАЛЬНЫЙ"],
...
function t_store_paramsToObj(t, e) {
    ...
    try {
        ...
        console.log(l), r = window.location.search
    }
    var o = {
        otherParams: []
    };
