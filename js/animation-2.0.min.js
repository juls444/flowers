...
function t_animate__animateNumbers(e) {
    ...
    var a, n, i, r, o, s, l = e.getAttribute("data-animate-number-count"),
        ...
        u = !1,
        d = !1,
        y = (e.removeAttribute("data-animate-number-count"), null !== _ && (d = -1 !== _[0].indexOf(",")), c.forEach(function (t, e) {
            var a;
            null !== _ && (-1 !== t.indexOf(",") && (a = t.split(",")), -1 !== t.indexOf(".") && (a = t.split(".")), -1 === t.indexOf(",") && -1 === t.indexOf(".") || (f = a[1].length, c[e] = +a.join("."), u = !0))
        }), e.querySelector(".t-animate__number"));
    c[0] && (n = Number(c[0]) || 0, i = 0, r = Math.pow(10, f), u && (n *= r, i *= r), o = 0, s = setInterval(function () {
        var t;
        i += n / 108, o = u ? (Math.round(i) / r).toFixed(f) + "" : Math.floor(i) + "", 1 < a.length && (o = o.replace(/(\d)(?=(\d{3})+([^\d]|$))/g, "$1 ")), d && (o = o.replace(/\./g, ",")), y && (y.textContent = o), n <= i && (clearInterval(s), e.innerHTML = l, t = e.querySelectorAll("span"), Array.prototype.forEach.call(t, function (t) {
...
function t_animate__getGroupsOffsets(t) {
    t.forEach(function (t) {
        var e = t.querySelector(".t-animate");
        e && (t.curTopOffset = e.getBoundingClientRect().top + window.pageYOffset, e = t_animation__getZoom(t), window.isOnlyScalable || (t.curTopOffset *= e))
    })
}
