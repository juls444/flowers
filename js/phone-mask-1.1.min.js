...
function t_form_phonemask__mulitple__load(e) {
    if (e.length) {
        var t = e[0],
            n, a, o;
        t_form_phonemask_init(t.getAttribute("data-phonemask-id"), t.getAttribute("data-phonemask-lid"), t.getAttribute("data-phonemask-maskcountry") || "", {
            multiple: !0
...
function t_form_phonemask_init(e, t, n, a) {
    var o, p = (a || {}).multiple,
        i, r = void 0 !== p && p ? t_form_phonemask__multiple__initPhoneMaskForm : t_form_phonemask_initPhoneMaskForm;
    if (n && "undefined" !== n) r(e, t, n);
    else if (window.geoCountry) r(e, t, window.geoCountry);
    else if (window.geoCountryRequested) document.addEventListener("geoCountryLoaded", (function () {
        r(e, t, window.geoCountry)
    }));
    else {
        var s = new XMLHttpRequest;
        s.open("GET", "https://geo.tildacdn.com/geo/country/", !0), s.onreadystatechange = function () {
            if (4 === s.readyState)
                if (s.status >= 200 && s.status < 400) {
                    n = s.responseText, window.geoCountry = n;
                    var a = document.createEvent("Event");
                    a.initEvent("geoCountryLoaded", !0, !1), document.dispatchEvent(a), r(e, t, n)
                } else r(e, t, "")
        }, s.send(), window.geoCountryRequested = !0
    }
}
...
function t_form_phonemask_initPhoneMaskForm(e, t, n) {
    ...
    if (a) {
        ...
        if (o && !o.getAttribute("data-init-mask")) {
            ...
            t_form_phonemask__saveISOtoLocalStorage(p.iso), t_form_phonemask__prepareInputGroup({
                rec: a,
                group: o,
                countryConfig: p,
                lid: t
...
function t_form_phonemask__multiple__initPhoneMaskForm(e, t, n) {
    ...
    if (a) {
        ...
        if (o && !o.getAttribute("data-init-mask")) {
            ...
            var p = t_form_phonemask__prepareISOandCountry(n),
                i;
            t_form_phonemask__saveISOtoLocalStorage(p.iso), o.querySelectorAll(".t-phonemask-input-group").forEach((function (e) {
                t_form_phonemask__prepareInputGroup({
                    group: e,
                    countryConfig: p,
                    rec: a,
                    lid: t
...
function t_form_phonemask__replaceInput(e) {
    ...
    if (t) {
        ...
        o && r.classList.add("t-input_bbonly");
...
function t_form_phonemask__prepareInputGroup(e) {
    ...
    if (s) {
        var m = t_form_phonemask__preparePhoneMaskInput(s, {
                lid: a,
                iso: p,
                country: r
            }),
            c = m.code,
            l = m.placeholder,
            u = t.querySelector(".t-input-phonemask__select-flag"),
            x = t.querySelector(".t-input-phonemask__select-code"),
            d;
        u.setAttribute("data-phonemask-flag", p), x.innerHTML = c, t_form_phonemask__changeMinLength(l, c, t), t_form_phonemask__addCurrentStyle(t), t.querySelector(".t-input-phonemask__options-wrap").innerHTML = t_form_phonemask__getDrawSelector(i), t_form_phonemask__initSelectEvents(o, t, i)
    }
}
...
function t_form_phonemask__preparePhoneMaskInput(e, t) {
    var n = t.iso,
        ...
        p = a.c || "",
        i = a.m || "",
        r = i ? i.substr(p.length).replace(/^-+/, "") : "";
    return e.setAttribute("id", "input_" + o), e.setAttribute("data-phonemask-iso", n), e.setAttribute("data-phonemask-code", p), e.setAttribute("data-phonemask-mask", i), e.setAttribute("placeholder", r), t_form_phonemask__calcMaxlength(e), {
        code: p,
        mask: i,
        placeholder: r
    }
...
function t_form_phonemask__triggerInitMask(e) {
    e.setAttribute("data-init-mask", "yes"), t_triggerEvent(e, "phoneMaskReady")
}
...
function t_form_phonemask__addCurrentStyle(e) {
    ...
    a.style.overflow = "visible", "rgb(0, 0, 0)" !== p && (n.style.color = p), n.style.fontSize = i, n.style.fontWeight = r, n.style.fontFamily = s, o.style.fontSize = i, o.style.fontWeight = r
}
...
function t_form_phonemask__initSelectEvents(e, t, n) {
    var a = e.querySelectorAll(".t-cover, .t396__artboard"),
        o = t.querySelector(".t-input-phonemask"),
        p = t.querySelector(".t-input-phonemask__select"),
    ...
    function l() {
        if (i.classList.contains("t-input-phonemask__options-wrap_open") ? u() : (u(), i.classList.add("t-input-phonemask__options-wrap_open")), 1 === a.length) {
            var n = a[0].getBoundingClientRect().height,
                o = t.getBoundingClientRect(),
                p = o.y - e.getBoundingClientRect().y,
                r = o.height,
                s = i.getBoundingClientRect().height,
                m = p + s + r,
                c = o.y - s + window.scrollY;
    ...
    function d() {
        t_form_phonemask__chooseCountry(t, this), t_form_phonemask__calcMaxlength(o), u()
    }
    ...
    function h(e) {
        ...
        if (t) {
            var a = /[-[\]/{}()*+?.\\^$|]/g,
                ...
                p = [];
            if (o && o.classList.remove("t-input-phonemask__options-item_chosen"), e.keyCode >= 48 && e.keyCode <= 57 || e.keyCode >= 96 && e.keyCode <= 105) {
                for (var i in s = (s += e.key).replace(a, "\\$&"), n) t_form_phonemask__searchCountry(t, s, p, i, n[i].c);
                t_form_phonemask__scrollToCountry(t, p)
            } else if (e.keyCode >= 65 && e.keyCode <= 90 || 32 == e.keyCode) {
                for (var i in s = (s += e.key).replace(a, "\\$&"), n) t_form_phonemask__searchCountry(t, "^" + s, p, i, n[i].n);
                t_form_phonemask__scrollToCountry(t, p)
            }
            c()
        }
    }
    t_form_phonemask__changeVal(t, o), p.addEventListener("click", l), o.addEventListener("paste", (function (e) {
        var t = (e.clipboardData || window.clipboardData).getData("text");
        if (t) {
            t = t.replace(/[^0-9+]/g, "");
            var n = e.target;
            n && (n.value = t, x.call(n), e.preventDefault())
        }
    })), o.addEventListener("input", x), Array.prototype.forEach.call(r, (function (e) {
        e.addEventListener("click", d)
    })), document.addEventListener("mouseup", _), document.addEventListener("keyup", h), document.querySelector('[data-init-mask="yes"]') || (document.addEventListener("mouseup", _), document.addEventListener("keyup", h))
}
...
function t_form_phonemask__addNumberMask(e, t) {
    var n = t.getAttribute("data-phonemask-code"),
        ...
        r = "";
    if (i) {
        for (var s = 0; s < i.length; s++) "9" === i[s][0] ? (r += p.slice(0, i[s].length).join(""), p.splice(0, i[s].length)) : r += i[s];
...
function t_form_phonemask__chooseCountry(e, t) {
    var n = e.querySelector(".t-input-phonemask"),
        ...
        o = e.querySelector(".t-input-phonemask__select-flag"),
        p = t.getAttribute("data-phonemask-code"),
        i = t.getAttribute("data-phonemask-mask"),
        r = t.getAttribute("data-phonemask-country-code"),
        s = n.getAttribute("data-phonemask-current");
    n.setAttribute("data-phonemask-iso", r), n.setAttribute("data-phonemask-code", p), n.setAttribute("data-phonemask-mask", i);
    var m = i.substr(p.length).replace(/^-+/, "");
    n.setAttribute("placeholder", m), a.innerHTML = p, o.setAttribute("data-phonemask-flag", r);
    try {
        localStorage.setItem("iso_code", r)
    } catch (c) {
        console.error("Your web browser does not support storing a ISO Phone Code data locally.")
    }
    n.focus(), s && t_form_phonemask__addNumberMask(s, n), t_form_phonemask__changeVal(e, n), t_form_phonemask__changeMinLength(m, p, e)
}

function t_form_phonemask__searchCountry(e, t, n, a, o) {
    var p = new RegExp(t, "i"); - 1 !== o.search(p) && (n.push(e.querySelector("#t-phonemask_" + a)), n[0].classList.add("t-input-phonemask__options-item_chosen"))
}
...
function t_form_phonemask__changeMinLength(e, t, n) {
    ...
    if (e && t) {
        var o = 1,
            p = n.querySelector(".t-input-phonemask"),
            i = n.querySelector(".js-phonemask-result"),
            r = p.getAttribute("data-phonemask-code"),
            s = {
                "+49": 1,
                "+372": 1,
                "+355": 1,
...
Array.prototype.some || (Array.prototype.some = function (e) {
        ...
        for (var t = Object(this), n = t.length >>> 0, a = arguments.length >= 2 ? arguments[1] : void 0, o = 0; o < n; o++)
            if (o in t && e.call(a, t[o], o, t)) return !0;
        return !1
    }),
    function (e) {
