function t_forms__initForms() {
    ...
    window.t_forms__inputData = {}, t_forms__addRecaptcha(), Array.prototype.forEach.call(t, (function (t) {
        var e = t.id;
        window.initForms[e] || (t_forms__initEventPlaceholder(t), t_forms__addInputItsGood(t), t_forms__addAttrAction(t), t_forms__onSubmit(t), t_forms__onClick(t), t_forms__onRender(t), t_forms__addFocusOnTab(t), t_onFuncLoad("t_throttle", (function () {
...
function t_forms__removePlaceholder(t) {
    ...
    if ("INPUT" === e.tagName) {
        var r = e.closest("[data-input-lid]"),
            ...
            n = "";
        if (r) n = r.getAttribute("data-input-lid");
        else {
        ...
        if (o) {
            ...
            if (r.tildaSendingStatus && (i = r.tildaSendingStatus), !(i && i >= 1 || t_hasClass(r, "t706__submit_disable"))) {
                ...
                var s, l = document.getElementById("allrecords").getAttribute("data-tilda-formskey"),
                    c = parseInt(o.getAttribute("data-formactiontype")),
                    d;
                ...
                if (o.querySelector(".g-recaptcha") && grecaptcha) {
                    ...
                    if (f) grecaptcha.reset(f);
                        ...
                        f = grecaptcha.render(n + "recaptcha", _), o.tildaCaptchaClientId = f
                    }
                    grecaptcha.execute(f)
                } else window.tildaForm.send(o, r, c, l)
            }
        }
    }
}
...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
        ...
        for (var e = t_forms__getElement(t), r = e.querySelectorAll(".js-tilda-rule"), o = [], n = !0, a, i = t_forms__getConditionCheckHandler(e).isHiddenByCondition, s = 0; s < r.length; s++) {
            ...
            if (!i(l)) {
                ...
                _.obj = l, _.type = [], w && w.length && (y = w.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, ""), w = w.trim()), p && (p = parseInt(p, 10)), f && (f = parseInt(f, 10));
                var b = !w.length && !y.length,
                    E = "checkbox" === h || "radio" === h,
                    F = e.querySelectorAll('[name="' + g + '"]:checked').length;
                if ((w.length && !E || E && F) && (n = !1), c && (b || E && !F)) _.type.push("req");
                else {
                    switch (d) {
                        case "email":
                            u = /^(?!\.)(?!.*\.\.)[a-zA-Zёа-яЁА-Я0-9\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD_\.\-\+]{0,63}[a-zA-Zёа-яЁА-Я0-9\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD_\-\+]@[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéû0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéû0-9\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я]{2,11}$/gi, w.length && !w.match(u) && _.type.push("email");
                            break;
                        case "url":
                            u = /^((https?|ftp):\/\/)?[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я]{2,10}\/?$/gi, w.length && ((m = (m = (m = w.split("//")) && m.length > 1 ? m[1] : m[0]).split("/")) && m.length && m[0] ? (m = m[0]).match(u) || _.type.push("url") : (m && !m[0] || _.type.push("url"), m = ""));
                            break;
                        case "phone":
                            var x = l.getAttribute("data-tilda-mask"),
                                A = "^[0-9()+-";
                            x && (-1 !== x.indexOf("*") ? A += "a-zёа-я" : (-1 !== x.indexOf("a") && (A += "a-z"), -1 !== x.indexOf("а") && (A += "а-яё"))), A += "]+$", u = new RegExp(A, "gi"), (y.length && !y.match(u) || 1 == (m = y.replace(/[^0-9]+/g, "")).indexOf("000") || 1 == m.indexOf("111") && "9" != m.substring(0, 1) || 1 == m.indexOf("222") && "5" != m.substring(0, 1) || 1 == m.indexOf("333") || 1 == m.indexOf("444") || 1 == m.indexOf("555") && "0" != m.substring(0, 1) || 1 == m.indexOf("666") && "0" != m.substring(0, 1) || 1 == m.indexOf("8888") && "4" != m.substring(0, 1)) && _.type.push("phone");
                            break;
                        case "number":
                            u = /^[0-9]+$/gi, y.length > 0 && !y.match(u) && _.type.push("number");
                            break;
                        case "date":
                        ...
                        case "name":
                            ...
                            break;
                        case "nameeng":
                            u = /^([A-Za-z\s]{1,}((\-)?[A-Za-z\.\s](\')?){0,})*$/i, w.length && !w.match(u) && _.type.push("nameeng");
                            break;
                        case "namerus":
                            u = /^([А-Яа-яЁё\s]{1,}((\-)?[А-Яа-яЁё\.\s](\')?){0,})*$/i, w.length && !w.match(u) && _.type.push("namerus");
                            break;
                        case "string":
                    ...
                    p > 0 && w.length && w.length < p && _.type.push("minlength"), f > 0 && w.length && w.length > f && _.type.push("maxlength")
                }
        ...
        if ("y" === v) {
            var k = window.tcart_minorder > 0,
                ...
                j, _, _;
            if (k)
                if ((window.tcart.prodamount_withdiscount > 0 ? window.tcart.prodamount_withdiscount : void 0 !== window.tcart.prodamount_withdyndiscount && window.t_cart__discounts && window.t_cart__discounts.length > 0 ? window.tcart.prodamount_withdyndiscount : window.tcart.prodamount) < window.tcart_minorder)(_ = {
                    obj: {},
                    type: []
                }).type.push("minorder"), o.push(_);
            if (C && window.tcart.total < window.tcart_mincntorder)(_ = {
                obj: {},
                type: []
            }).type.push("minquantity"), o.push(_)
        }
        ...
        for (var p = 0; p < e.length; p++)
            if (e[p] && e[p].obj) {
                ...
                f && (a = f.closest(n)), a && (c = a.querySelectorAll(".t-input-error"), t_addClass(a, "js-error-control-box"), c.length && (i = !0));
                for (var _ = 0; _ < e[p].type.length; _++) {
                    var w = e[p].type[_],
                        y = t_forms__getMsg(w);
                    d = "", (l = r.querySelector(".js-rule-error-" + w)) ? l.textContent && l.innerText || !y || -1 !== u.indexOf(y) ? (d = l.textContent || l.innerText, -1 === u.indexOf(d) && (u = u + '<p class="t-form__errorbox-item">' + d + "</p>")) : u = u + '<p class="t-form__errorbox-item">' + y + "</p>" : y && -1 === u.indexOf(y) && (u = u + '<p class="t-form__errorbox-item">' + y + "</p>"), i && (!d && t_forms__getMsg(w + "field") ? d = t_forms__getMsg(w + "field") : y && (d = y), d && a && (c = a.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(c, (function (t) {
            ...
            if (Array.prototype.forEach.call(h, (function (t) {
                ...
                if (g && g.length) {
                    var v, b = '.t1093 .t-popup[data-tooltip-hook="' + g[g.length - 1] + '"]',
        ...
        if (window.t_forms__errorTimerID && window.clearTimeout(window.t_forms__errorTimerID), window.t_forms__errorTimerID = window.setTimeout((function () {
            ...
            var S = r.closest(".r"),
                k = "focus";
            document.addEventListener || (k = "focusin"), t_removeEventListener(S, k, A), t_addEventListener(S, k, A, !0), t_removeEventListener(S, "change", A), t_addEventListener(S, "change", A, !0)
        }
        ...
        for (var n, a = (r || {}).inputBoxSelector, i, s = void 0 === a ? o.getAttribute("data-inputbox") || ".blockinput" : a, l = t_forms__createErrorFocusHash(), c = 0; c < e.length; c++) {
            ...
            if (u && u.obj) {
                ...
                var p = t_forms__getElement(m),
                    f;
                if (p && p instanceof Element) t_forms__showInputErrors(o, p.closest(s), u);
                                ...
                                if (objData && objData.error) {
                                    ...
                                    if ("y" === dataFormCart && null != (_objData$member = objData.member) && _objData$member.token) {
                                        ...
                                        localStorage.setItem(profileName, JSON.stringify(memberInfo)), localStorage.setItem(profileName + "_timestamp", Math.floor(Date.now() / 1e3).toString()), t_onFuncLoad("t_bd__init", (function () {
                                            t_bd__init(), window.tcart_isAuthInited = !1, tcart__initAuthAndDelivery()
                                        }))
                                    }
                                    try {
            ...
            return xhr.open("POST", form.getAttribute("action"), !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), xhr.onreadystatechange = function () {
                if (4 === xhr.readyState)
                    if (xhr.status >= 200 && xhr.status < 400) {
                        ...
                        if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", o = xhr.responseText)
                            if ("{" == o.substring(0, 1)) {
                                ...
                                if ("object" == typeof n)
                                    ...
                                    var a, i = (a = t_forms__getErrorContainers(form, "Unknown error. Please, try again later.")).errorBoxes,
                                        s = a.allError;
                        ...
                        t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0";
                        var a, i = (a = t_forms__getErrorContainers(form, "")).errorBoxes,
                            s = a.allError,
                            o = xhr.responseText;
                        Array.prototype.forEach.call(s, (function (t) {
    ...
    if (t) {
        ...
        if (e) {
            ...
            if (n) {
                ...
                if (a) {
                    var u, m = e.querySelector(".t-contact-method__value-container > :not(.t-contact-method__hidden)").querySelector(".t-input-block:not(.t-contact-method__hidden)"),
                        p = m.querySelector(".js-username-input"),
                        f;
                    return p ? void r(p) : void r(m.querySelector(".t-input-phonemask"))
                }
                var _, w, y;
                if (i) r(e.querySelector(".t-img-select"));
                else if (s) r(e.querySelector(".t-checkbox"));
                else if (l) r(e.querySelector(".t-select"));
                else if (c) e.scrollIntoView({
                    block: "center"
                });
                else {
...
function t_forms__onSuccess(t) {
    var e = t_forms__getElement(t),
        ...
        l, c, d = n.clientHeight - (i + s) + (n.getBoundingClientRect().top + window.pageYOffset),
        ...
        y = Math.max(_.scrollHeight, _.offsetHeight, w.clientHeight, w.scrollHeight, w.offsetHeight);
    if (121 == o) {
    ...
    if (m > window.scrollY || y - d < f - 100) n.classList.add(g), f > y && E && setTimeout((function () {
        t_fadeOut(E)
    }), 300);
    else {
        for (var F = 0; F < v.length; F++)
            if (v[F] == o) {
                b = !1;
                break
            } b && t_forms__scrollBeginForm(p), setTimeout((function () {
            n.classList.add(g)
        }), 400)
    }
    ...
    if (x && setTimeout((function () {
        ...
        A && (A.style.display = "none"), S && (S.style.minHeight = ""), k && (k.style.minHeight = "")
    }
}
...
function t_serializeArray(t) {
    for (var e = [], r = t.querySelectorAll("input, textarea, button, select"), o, n = t_forms__getConditionCheckHandler(t).isHiddenByCondition, a = 0; a < r.length; a++)
        if (!(!r[a].name || r[a].disabled || ["file", "reset", "submit", "button"].indexOf(r[a].type) > -1 || n(r[a])))
            if ("select-multiple" !== r[a].type)["checkbox", "radio"].indexOf(r[a].type) > -1 && !r[a].checked || e.push({
                name: r[a].name,
                value: r[a].value
            });
            else
                for (var i = r[a].options, s = 0; s < i.length; s++) i[s].selected && e.push({
                    name: i[s].name,
                    value: i[s].value
                });
    return e
