if (window.t_cart__isiOS = !1, /iPhone|iPad|iPod/i.test(navigator.userAgent) && (window.t_cart__isiOS = !0), window.t_cart__iOSMajorVersion = "", window.t_cart__isiOS) {
...
function tcart__init(t, e) {
    ...
    if (e || (e = r && r.getAttribute("data-yandexmap-apikey") || ""), window.tcart__ymapApiKey = e, "yes" === window.tcart_initted && o > 1) {
        ...
        })), void(void 0 === window.tcart_erroralert && (alert(a), window.tcart_erroralert = "yes", console.error("Error: Two cart widgets (block ST100) on the page. Remove a duplicate.")))
    }
    if (r) {
        var n, i;
        "y" == r.getAttribute("data-cart-dontstore") && (window.tcart_dontstore = "y"), "y" == r.getAttribute("data-cart-oneproduct") && (window.tcart_oneproduct = "y");
        var c = r.getAttribute("data-cart-maxstoredays"),
            d;
        if (c && (window.tcart_maxstoredays = c), "y" == r.getAttribute("data-cart-sendevent-onadd") && (window.tcart_sendevent_onadd = "y"), window.tcart_fullscreen = "yes" === r.getAttribute("data-cart-fullscreen"), window.tcart_fullscreen) {
            var s = "https://static.tildacdn.com/css/tilda-cart-fullscreen-1.0.min.css",
                u;
            if (!document.querySelector('link[href^="' + s + '"]')) {
                var l = document.createElement("link");
                l.setAttribute("rel", "stylesheet"), l.setAttribute("type", "text/css"), l.setAttribute("href", s), document.getElementsByTagName("head")[0].appendChild(l), document.querySelector("body").insertAdjacentElement("beforeend", l)
            }
            if ("matchMedia" in window || "msMatchMedia" in window) {
                ...
                var w = function r(o) {
                    "function" == typeof p.addEventListener ? p.removeEventListener("change", r) : p.removeListener(r), o.matches !== window.tcart_isMobile && (window.tcart_isMobile = o.matches, tcart__init(t, e), tcart__syncProductsObject__LStoObj(), tcart__updateProductsPrice(), tcart__reDrawProducts(), tcart__reDrawTotal(), tcart__initAuthAndDelivery(), tcart__restoreFieldsFromLS())
                };
        ...
        if (-1 != window.location.href.indexOf("#!/torder")) {
            ...
            var f = document.getElementById("allrecords"),
                v = f.getAttribute("data-tilda-project-id"),
                h = f.getAttribute("data-tilda-formskey"),
                g;
            tcart__getLostCart({
                projectid: v,
        ...
        b && (b.innerHTML = tcart_dict("clickToOrder")), document.querySelector('script[src*="tilda-widget-positions"]') || t_onFuncLoad("t_loadJsFile", (function () {
            t_loadJsFile("https://static.tildacdn.com/js/tilda-widget-positions-1.0.min.js")
        })), tcart__drawBottomTotalAmount(), tcart__loadLocalObj(), tcart__reDrawCartIcon(), tcart__addEvent__links(), tcart__addEvents(), tcart__updateMinimals(), tcart__loadDiscounts(), window.addEventListener("pageshow", (function (t) {
        ...
        S && (S.setAttribute("data-animationappear", "off"), S.style.opacity = "1");
        var E = r.querySelector(".t706__cartwin-prodamount-label"),
            L = r.querySelector(".t706__cartwin-totalamount-label");
        if (r.querySelector(".t-input-group_dl") ? (E && (E.innerHTML = tcart_dict("subtotal") + ": "), L && (L.innerHTML = tcart_dict("grandTotal") + ": ")) : (E && (E.innerHTML = tcart_dict("total") + ": "), L && (L.innerHTML = tcart_dict("total") + ": ")), window.tcart_fullscreen) {
            var E;
            ...
            var q = r.querySelector(".t706__cartpage-order-total-label");
            q && (q.innerHTML = tcart_dict("grandTotal") + ":&nbsp;")
        }
        if (window.tcart_fullscreen) {
            var A = r.querySelector(".t706__cartpage-heading"),
                T = r.querySelector(".t706__sidebar-heading");
            "" === A.innerHTML && (A.innerHTML = tcart_dict("yourOrder")), "" === T.innerHTML && (T.innerHTML = tcart_dict("yourOrder"))
        } else {
            var A;
        ...
        if ("Submit" == j.innerHTML && (j.innerHTML = tcart_dict("submitOrder")), window.tcart_fullscreen) {
        ...
        var C = r.querySelector(".t-form__submit"),
            O = r.querySelector(".t706__minimal");
        if (C && O && (C.addEventListener("mouseenter", (function () {
            ...
            if (D) {
                var I = D.getAttribute("data-tilda-mode"),
                    M;
                "edit" !== I && "preview" !== I && (window.history.replaceState("", document.title, window.location.href.split("#")[0]), tcart__openCart())
            }
        }
...
function tcart__initAuthAndDelivery() {
    return tcart__form__hideErrors(), tcart__blockSubmitButton(), tcart__auth__init().then((function (t) {
        var e, r = t || (null == (e = window.tcart) ? void 0 : e.authState) || {},
            o = r.lkpSettings,
            a = r.mauser,
            n = !(null != a && a.token) && "required" === (null == o ? void 0 : o.auth_required);
        n || (tcart__initDelivery(), tcart__form__showFormFields()), n && (tcart__form__hideFormFields(), tcart__hideBottomTotalAmount(), tcart__form__disableFormFields(), tcart__form__insertValidateRule("unauthorized_order"))
    })).finally((function () {
...
function tcart__updateMinimals() {
    ...
    function i(e, r) {
        ...
        window.tcart_fullscreen ? (t.querySelector(".t706__sidebar-prodamount-wrap").insertAdjacentHTML("afterbegin", e), t.querySelector(".t706__cartpage-prodamount").insertAdjacentHTML("afterbegin", e), o.forEach((function (t) {
            t.insertAdjacentHTML("afterbegin", e)
        }))) : (t.querySelector(".t706__cartwin-prodamount-wrap").insertAdjacentHTML("afterbegin", e), o.forEach((function (t) {
            t.insertAdjacentHTML("afterbegin", e)
        }))), t.querySelector(".js-errorbox-all .t-form__errorbox-text").insertAdjacentHTML("beforeend", r)
    }
    window.tcart_minorder && i(o = '<div class="t706__cartwin-prodamount-minorder t706__minimal"><span>' + tcart_dict("minimumOrder") + ": " + tcart__showPrice(e) + "</span></div>", a = '<div data-rule-filled="true" class="t-form__errorbox-item js-rule-error js-rule-error-minorder" style="display: none;">' + tcart_dict("minimumOrder") + ": " + tcart__showPrice(e) + "</div>");
    window.tcart_mincntorder && i(o = '<div class="t706__cartwin-prodamount-mincntorder t706__minimal"><span>' + tcart_dict("minimumQuantity") + ": " + r + "</span></div>", a = '<p data-rule-filled="true"  class="t-form__errorbox-item js-rule-error js-rule-error-minquantity" style="display: none;">' + tcart_dict("minimumQuantity") + ": " + r + "</p>")
}
...
function tcart__loadLocalObj() {
    ...
    if (window.tcart = null === t ? tcart__nullObj() : JSON.parse(t), void 0 !== window.tcart.products) {
        ...
        })), window.tcart.products = o, window.tcart.products.length !== a && tcart__saveLocalObj()
    }
    if (window.tcart_maxstoredays) {
        var i = parseInt(window.tcart_maxstoredays);
        i > 0 ? window.tcart.updated > 0 && (r = 1 * (e = Math.floor(Date.now() / 1e3)) - 1 * window.tcart.updated) > 86400 * i && ("object" == typeof localStorage && (window.tcart.products = [], localStorage.setItem("tcart", JSON.stringify(window.tcart))), window.tcart = tcart__nullObj()) : 0 === i && (window.tcart = tcart__nullObj())
    } else window.tcart.updated > 0 && (r = 1 * (e = Math.floor(Date.now() / 1e3)) - 1 * window.tcart.updated) > 2592e3 && (window.tcart = tcart__nullObj());
    "y" === window.tcart_dontstore && (window.tcart = tcart__nullObj()), delete window.tcart.currency, delete window.tcart.currency_txt, delete window.tcart.currency_txt_l, delete window.tcart.currency_txt_r, delete window.tcart.currency_side, delete window.tcart.currency_sep, delete window.tcart.currency_dec, window.tcart.currency = "$", window.tcart.currency_side = "l", window.tcart.currency_sep = ".", window.tcart.currency_dec = "", window.tcart.delivery && delete window.tcart.delivery, window.tcart.promocode && delete window.tcart.promocode;
    var c = document.querySelector(".t706"),
        d = c.getAttribute("data-project-currency");
    d && (window.tcart.currency = d), window.tcart.currency_txt = window.tcart.currency;
    var s = c.getAttribute("data-project-currency-side");
    "r" == s && (window.tcart.currency_side = "r"), "l" == window.tcart.currency_side ? (window.tcart.currency_txt_l = window.tcart.currency_txt + "", window.tcart.currency_txt_r = "") : (window.tcart.currency_txt_r = " " + window.tcart.currency_txt, window.tcart.currency_txt_l = ""), "." == (s = c.getAttribute("data-project-currency-sep")) || "," == s ? window.tcart.currency_sep = s : "$" == window.tcart.currency || "€" == window.tcart.currency || "USD" == window.tcart.currency || "EUR" == window.tcart.currency ? window.tcart.currency_sep = "." : window.tcart.currency_sep = ",", s = c.getAttribute("data-project-currency-dec"), window.tcart.currency_dec = "00" == s ? s : "", delete window.tcart.system;
    var u = c.getAttribute("data-payment-system");
    ...
    _ > 0 && void 0 === window.tcart_mincntorder && (_ *= 1, window.tcart_mincntorder = _), tcart__addDelivery(), tcart__updateTotalProductsinCartObj()
}

function tcart__saveLocalObj() {
    if (window.tcart_newDeliveryActive && window.tcart.amount && window.tcart.total && tcart__rerenderDeliveryServices(), "y" !== window.tcart_dontstore && (void 0 === window.tcart_maxstoredays || 0 != window.tcart_maxstoredays) && "object" == typeof window.tcart) {
...
function tcart__syncProductsObject__LStoObj() {
    if ("y" !== window.tcart_dontstore && (void 0 === window.tcart_maxstoredays || 0 != window.tcart_maxstoredays) && "object" == typeof localStorage) try {
        ...
        if ("object" == typeof e.products) {
            ...
            })), window.tcart.products = r, window.tcart.products.length !== o && tcart__saveLocalObj(), tcart__updateTotalProductsinCartObj()
        }
    } catch (n) {}
}
...
function tcart__addEvents() {
    ...
    e("body", (function (t) {
        ...
        tcart__openCart()
    })), e(".t706__cartwin-close", tcart__closeCart), e(".t706__cartwin-closebtn", tcart__closeCart), window.tcart_fullscreen && (e(".t706__sidebar-close", tcart__closeCartSidebar), e(".t706__sidebar-continue", tcart__openCartFullscreen), e(".t706__cartpage-back", tcart__closeCartFullscreen), e(".t706__cartpage-close", tcart__closeCartFullscreen), window.addEventListener("popstate", (function () {
    ...
    if (o ? o.addEventListener("mousedown", (function (t) {
        ...
        var a = document.querySelector(".t706__cartpage-totals"),
            n;
        ...
        if (e.isTrusted && !window.clearTCart && !document.hasFocus() && "tcart" === e.key) {
            try {
                var r = localStorage.getItem("tcart"),
                    o = JSON.parse(r);
                "object" == typeof o.products && (window.tcart.products = o.products, tcart__updateTotalProductsinCartObj())
            } catch (e) {}
            tcart__reDrawCartIcon(), t.classList.contains("t706__body_cartwinshowed") && (window.tcart_newDeliveryActive && window.tcart.amount && window.tcart.total && tcart__rerenderDeliveryServices(), tcart__reDrawProducts(), tcart__reDrawTotal())
        }
    }))
}
...
function tcart__addEvent__links(t) {
    ...
    var r = document.querySelector("body"),
        o = function t(e) {
            ...
            if (o && (e.preventDefault(), !e.target.classList.contains("t1002__addBtn") && !e.target.closest(".t1002__addBtn"))) {
                var a = o.closest("form");
                if (a && !a.closest(".t-quiz")) {
                    var n = window.tildaForm.validate(a);
                    if (window.tildaForm.showErrors(a, n)) return !1
                }
                if ("yes" != o.getAttribute("data-dbclk-prevent")) {
                    ...
                    }), 1e3), (r.classList.contains("t-body_popupshowed") || document.querySelectorAll(".t-popup.t-popup_show").length > 0) && (t_triggerEvent(document.body, "popupHidden"), r.classList.remove("t-body_popupshowed"), Array.prototype.forEach.call(document.querySelectorAll(".t-popup"), (function (t) {
                        ...
                        if (k) {
                            if (k.indexOf(":::") > 0) {
                                ...
                                if (k.indexOf("=") > 0 && k.indexOf("=") < k.indexOf(":::")) {
                                    var A = k.substring(q + 3);
                                    if (k = k.substring(0, q), -1 !== A.indexOf(":::"))
                            ...
                            if (k.indexOf("=") > 0) {
                                var x = k.split("=");
                                x[0] && (d = x[0].trim()), x[1] && (c = x[1]), c = tcart__cleanPrice(c)
                            } else d = k;
                            if (void 0 !== A && "" !== A && A.indexOf("=") > 0) {
                                var C = A.split("=");
                                C[0] && C[1] && "image" == C[0] && C[1].indexOf(".tildacdn.") > 0 && (s = C[1])
                            }
                            "" == p && (p = o.closest(".r").getAttribute("id") ? o.closest(".r").getAttribute("id").replace("rec", "") : "")
                        }
                    }
                    var O = o.closest(".js-product");
                    if (O) {
                        if ("" == d) {
                            var D = O.querySelector(".js-product-name");
                            d = D ? D.textContent.trim() : ""
                        }
                        if ("" == c || 0 == c) {
                            var I = O.querySelector(".js-product-price");
                            I && (c = I.classList.contains("js-store-prod-price-range-val") ? I.getAttribute("data-product-price-range-val") : I.textContent), c = tcart__cleanPrice(c)
                        }
                        if ("" == s)
                            if (O.getAttribute("data-product-img")) s = O.getAttribute("data-product-img");
                            else {
                                var M = O.querySelector(".js-product-img");
                                if (M) {
                                    var R = M.getAttribute("data-original") || "";
                                    if (R.length > 0) s = R;
                                    else if ("IMG" == M.tagName) s = M.getAttribute("src");
                            ...
                            } if ("" == l && (l = O.getAttribute("data-product-lid") || ""), "" == _ && (_ = O.getAttribute("data-product-uid") || ""), "" == p) {
                            var F = O.closest(".r").getAttribute("id");
                            p = F ? F.replace("rec", "") : ""
                        }
                        "" == w && (w = O.getAttribute("data-product-inv") || ""), y = O.getAttribute("data-product-unit") || "", f = O.getAttribute("data-product-portion") || "", m = O.getAttribute("data-product-single") || "";
                        var H = [],
                            U = O.querySelectorAll(".js-product-edition-option");
                        Array.prototype.forEach.call(U, (function (t) {
                            ...
                            if (r) {
                                ...
                                if (a = tcart__cleanPrice(a), e && o) {
                                    var n = {};
                                    "" != e && (e = tcart__escapeHtml(e)), "" != o && (o = (o = tcart__escapeHtml(o)).replace(/(?:\r\n|\r|\n)/g, "")), e.length > 1 && ":" == e.slice(-1) && (e = e.slice(0, -1)), n.option = e, n.variant = o, n.price = a, H.push(n)
                                }
                            }
                        }));
                        var N = O.querySelectorAll(".js-product-option");
                        ...
                        var z = O.querySelectorAll(".js-product-multioption");
                        ...
                        })), "" == u && (u = O.querySelector(".js-product-sku") ? O.querySelector(".js-product-sku").textContent.trim() : ""), "" == u && (u = O.querySelector(".js-store-prod-sku") ? O.querySelector(".js-store-prod-sku").textContent.trim() : ""), "" == v && (v = O.getAttribute("data-product-pack-label") || ""), "" == h && (h = O.getAttribute("data-product-pack-m") || ""), "" == g && (g = O.getAttribute("data-product-pack-x") || ""), "" == b && (b = O.getAttribute("data-product-pack-y") || ""), "" == S && (S = O.getAttribute("data-product-pack-z") || ""), "" == E && (E = O.getAttribute("data-product-part-uid") || ""), "" == L && (L = O.getAttribute("data-product-gen-uid") || "")
                    }
                    var B = O ? O.getAttribute("data-product-url") : "",
                        J = O ? O.querySelector('a[href="#order"]:not(.t-btn)') : "",
                        Z = O ? O.querySelector('.js-product-link:not([href="#prodpopup"]):not([href="#order"])') : "";
                    if (Z) var V = Z.getAttribute("href");
                    if (!B && V ? B = V : !B && p && l && !J ? B = window.location.origin + window.location.pathname + "#!/tproduct/" + p + "-" + l : B || (B = window.location.origin + window.location.pathname + "#rec" + p), "" != d || "" != c && 0 != c) {
                        "" == d && (d = "NoName"), "" == c && (c = 0), "" != d && (d = tcart__escapeHtml(d)), "" != s && (s = tcart__escapeHtmlImg(s));
                        var W = {};
                        if (W.name = d, W.price = c, W.img = s, W.recid = p, W.lid = l, W.pack_label = v, W.pack_m = h, W.pack_x = g, W.pack_y = b, W.pack_z = S, W.part_uids = E.split(","), W.gen_uid = L, W.url = B, H && H.length > 0 && (W.options = H), u && (u = tcart__escapeHtml(u), W.sku = u), _ && (W.uid = _), l && (W.lid = l), w > 0 && (W.inv = parseInt(w, 10)), "" === w || 0 !== parseInt(w, 10)) {
                            y && (W.unit = y), f && (W.portion = f), m && (W.single = m);
                            ...
                            if (G) {
                                ...
                                !isNaN(Y) && Y > 0 && (W.quantity = Y, Q.value = 1, t_triggerEvent(Q, "change"))
                            }
                            if (tcart__addProduct(W), "y" == window.tcart_sendevent_onadd) try {
                                Tilda.sendEcommerceEvent("add", [W])
                            } catch (et) {
                                if (window.Tilda && "function" == typeof Tilda.sendEventToStatistics) {
                                    var X = "/tilda/cart/add/";
                                    p > 0 && (X += p), _ && _ > 0 ? X += "-u" + _ : l && l > 0 && (X += "-" + l);
                                    var $ = d,
                                        tt = c;
...
function tcart__auth__init() {
    return new Promise((function (t) {
        var e, r;
        if (window.tcart_isAuthInited) return t();
        if (window.tcart_isAuthInited = !0, !document.querySelector('script[src*="tilda-buyer-dashboard"]')) return t();
        var o = tcart__form__getForm();
        if (!o) return t();
        if (void 0 !== (null == (e = window.tildaMembers) ? void 0 : e.is_init_store)) return t(a());

        function a() {
            var t = window.tildaMembers;
            if (!0 === t.is_init_store) return Promise.all([tcart__auth__getLkpSettings(), tcart__auth__getMembersSettings(), tcart__auth__getMauser()]).then((function (e) {
                var r = e[0],
                    o = e[1],
                    a = e[2],
                    i;
                if (r && o) return null != a && a.token ? (i = tcart__auth__createLoggedInEl(a), tcart__auth__fillUserFields(a)) : i = tcart__auth__createAuthEl(r, o), n(i), window.tcart.authState = {
                    lkpSettings: r,
                    members: t,
                    mauser: a
                }, {
        ...
        function n(t) {
            ...
            if (e) {
                ...
                r && r.remove(), e.insertAdjacentElement("afterbegin", t)
            }
        }
...
function tcart__auth__createAuthEl(t, e) {
    var r = t.auth_required,
        ...
        i = "/members/signup?redirecturl=" + o + a + "#opencart",
        c = tcart__auth__createWrapEl(),
        d = "";
    return d = (d = (d = e.allowselfreg ? tcart_dict("required" === r ? "authRequired" : "authNotRequired") : tcart_dict("required" === r ? "authRequiredNoRegister" : "authNotRequiredNoRegister")).replace("#login", n)).replace("#register", i), c.innerHTML = d, c
}
...
function tcart__auth__createLoggedInEl(t) {
    var e = t.name,
        r = void 0 === e ? "" : e,
        o = t.email,
        a, n, i = '<a href="' + "/members/orderlist" + '" class="t706__auth__link">' + r + " (" + (void 0 === o ? "" : o) + ")</a>",
        c = tcart__auth__createWrapEl(),
        d = tcart_dict("loggedIn");
    d = d.replace("#link", i), c.innerHTML = '\n        <div class="t-descr t706__auth__flex">\n            <p>' + d + '</p>\n            <button type="button" class="t706__auth__log-in-btn js-cart-log-out">\n                ' + tcart_dict("quit") + "\n            </button>\n        </div>\n    ";
    var s = c.querySelector(".js-cart-log-out");
    return s.addEventListener("click", u), c;

    function u() {
        t_onFuncLoad("tma__userbar__sendLogout", (function () {
            s.disabled = !0, tma__userbar__sendLogout({
...
function tcart__auth__onMembersLogout(t) {
    window.tcart_isAuthInited = !1, tcart__initAuthAndDelivery().then((function () {
...
function tcart__auth__getMauserFromLS() {
    var t, e = document.getElementById("allrecords").getAttribute("data-tilda-project-id"),
...
function tcart__auth__getUserFields() {
    var t, e = tcart__form__getFields().filter((function (t) {
        ...
        a, n;
    return {
        nameField: c(["name", "имя"]),
        emailField: i("email") || c(o)
    };
...
function tcart__auth__fillUserFields(t) {
    ...
    if (e || r) {
        var o = tcart__auth__getUserFields(),
            a = o.nameField,
            n = o.emailField;
        (a || n) && (a === n ? n.value = e || r : (a && r && (a.value = r), n && e && (n.value = e)))
    }
}
...
function tcart__auth__getLkpSettings() {
    ...
    return tcart__fetchData("https://" + t_cart__getServerName() + "/api/orders/getordersmanagemntparams/").then((function (t) {
        return t.error ? Promise.reject(t.error) : t.ordersmanagement ? t.params : Promise.reject("ordersmanagement does not enabled")
    }))
}
...
function tcart__addProduct(t) {
    ...
    if (window.tcart__quantityProductsByUid = {}, window.tcart__quantityProductsByUid[t.uid] || (window.tcart__quantityProductsByUid[t.uid] = 0), o.forEach((function (e) {
            e.uid && t.uid && e.uid === t.uid && (window.tcart__quantityProductsByUid[t.uid] += parseInt(e.quantity, 10))
        })), t.quantity && (window.tcart__quantityProductsByUid[t.uid] += parseInt(t.quantity, 10)), parseInt(window.tcart__quantityProductsByUid[t.uid]) > parseInt(t.inv, 10)) return alert(tcart_dict("limitReached")), !1;
    var a = !1,
        n = !1;
    if (o.length > 0 && Array.prototype.forEach.call(o, (function (r, o) {
            ...
            if ("y" == window.tcart_oneproduct) {
                if (r.name == t.name && r.price == t.price) {
                    if (null == r.options && null == t.options && null == r.sku && null == t.sku) return a = !0, !1;
                    if (null == r.options && null == t.options && null != r.sku && null != t.sku && r.sku == t.sku) return a = !0, !1;
                    if ("object" == typeof r.options && "object" == typeof t.options && (Array.prototype.forEach.call(r.options, (function (e, r) {
                            if ("object" == typeof e && "object" == typeof t.options[r]) {
                                if (e.option !== t.options[r].option || e.variant !== t.options[r].variant || e.price !== t.options[r].price) return i = !1
                            } else if (null == e || null == t.options[r]) return i = !1
                        })), r.sku === t.sku && (c = "y"), "y" === i && "y" === c)) return parseInt(window.tcart.products[o].quantity, 10) === parseInt(t.inv, 10) && alert(tcart_dict("limitReached")), a = !0, !1
                }
            } else {
                if (t.options && r.options && Object.keys(t.options).length !== Object.keys(r.options).length) return i = !1;
                if (r.name == t.name && r.price == t.price && r.portion == t.portion && r.single == t.single) {
                    if ("object" == typeof r.options && "object" == typeof t.options && Array.prototype.forEach.call(r.options, (function (e, r) {
                        ...
                        n = !0, a = !0;
                        var d = parseInt(t.inv, 10),
                            s;
                        if ((s = parseInt(window.tcart.products[o].quantity, 10)) === d) return void alert(tcart_dict("limitReached"));
                        window.tcart.products[o].quantity++
                    }
                    if ("y" === i && "y" === c) {
                        var d = parseInt(t.inv, 10),
                            u = parseInt(t.quantity, 10),
                            s;
                        if ((s = parseInt(window.tcart.products[o].quantity, 10)) === d) return alert(tcart_dict("limitReached")), a = !0, !1;
                        if (void 0 !== t.quantity)
                            if (s + u > d) alert(tcart_dict("limitReached")), a = !0, window.tcart.products[o].quantity = d;
                            else {
                        ...
                        return window.tcart.products[o].amount = window.tcart.products[o].price * window.tcart.products[o].quantity, window.tcart.products[o].amount = tcart__roundPrice(window.tcart.products[o].amount), window.tcart.products[o].ts = e, a = !0, !1
                    }
                    ...
                    var d = parseInt(t.inv, 10),
                        u = parseInt(t.quantity, 10),
                        s;
                    if ((s = parseInt(window.tcart.products[o].quantity, 10)) === d) return alert(tcart_dict("limitReached")), n = !0, a = !0, !1;
                    if (void 0 !== t.quantity)
                        if (s + u > d) alert(tcart_dict("limitReached")), n = !0, a = !0, window.tcart.products[o].quantity = d;
                        else {
                            var l = parseInt(window.tcart.products[o].quantity, 10) + u;
                            window.tcart.products[o].quantity = l
                        }
                    else window.tcart.products[o].quantity++;
                    return window.tcart.products[o].price = 0, window.tcart.products[o].amount = 0, window.tcart.products[o].ts = e, n = !0, a = !0, !1
                }
            }
        })), !a) {
    ...
    tcart__updateTotalProductsinCartObj(), tcart__reDrawCartIcon(), tcart__saveLocalObj(), n && tcart__updateProductsPrice(!0);
    ...
    "yes" === d.getAttribute("data-opencart-onorder") ? setTimeout((function () {
        tcart__openCart()
    }), 10) : (r || s.length) && (r && (r.classList.add("t706__carticon_neworder"), setTimeout((function () {
        r.classList.remove("t706__carticon_neworder")
    }), 500)), s.length && Array.prototype.forEach.call(s, (function (t) {
...
function tcart__updateProductsPrice(t) {
    ...
    if (window.tcart && window.tcart.updated && window.tcart.products && window.tcart.products.length) {
        ...
        if (t && !window.tcart.ignoreTimestamp && (window.tcart.ignoreTimestamp = e), (e - r) / 3600 > 3 || t && (e - window.tcart.ignoreTimestamp) / 3600 > .02) {
            var o = {};
            o.prodamount = window.tcart.prodamount, o.discount = window.tcart.discount, o.products = JSON.stringify(window.tcart.products), o.amount = window.tcart.amount, o.total = window.tcart.total, o.updated = window.tcart.updated, o = JSON.stringify(o), window.tcart_endpoint || (window.tcart_endpoint = "store.tildacdn.com");
            var a = "https://" + window.tcart_endpoint + "/api/getpriceproducts/",
                n = new XMLHttpRequest;
            n.open("POST", a), n.onload = function () {
                if (n.status >= 200 && n.status < 400) {
                    ...
                    try {
                        var r = JSON.parse(t);
                        if ("error" === r.status) e = r.bad;
                        else if ("success" === r.status) return
                    } catch (o) {
                        console.error("Can't get JSON.", t)
                    }
                    if ("" === e) return void console.error("Something went wrong. Can't get products array.");
                    ...
                    Object.keys(e).forEach((function (t) {
                        ...
                        if ("PRICE_CHANGED" === r.error) {
                            var a = "";
                            r.variant && (a += r.variant + "|"), r.variant2 && (a += r.variant2 + "|"), r.variant3 && (a += r.variant3 + "|"), r.variant4 && (a += r.variant4 + "|"), r.variant5 && (a += r.variant5 + "|"), !a && r.options && r.options.forEach((function (t) {
                                ...
                                if (o === n) {
                                    if (void 0 !== t.options && void 0 !== r.options && a) {
                                        ...
                                        if (t.options.forEach((function (t) {
                                            ...
                                            })), a === i) return window.tcart.products[e].amount = parseFloat(r.last_amount), void(window.tcart.products[e].price = parseFloat(r.last_price))
                                    }
                                    if (void 0 === t.options && void 0 === r.options && void 0 === r.variant) return window.tcart.products[e].amount = parseFloat(r.last_amount), void(window.tcart.products[e].price = parseFloat(r.last_price))
                                }
                            }))
                        }
                    ...
                    })), tcart__saveLocalObj(), tcart__reDrawProducts(), tcart__updateTotalProductsinCartObj(), tcart__reDrawCartIcon(), tcart__reDrawTotal()
                }
...
function tcart__updateTotalProductsinCartObj() {
    ...
    if (r.length > 0) {
        ...
        Array.prototype.forEach.call(r, (function (t) {
            tcart__isEmptyObject(t) || "yes" === t.deleted || ("y" === t.single ? o += 1 : o += 1 * t.quantity, a = 1 * a + 1 * t.amount)
        })), a = tcart__roundPrice(a), window.tcart.total = o, window.tcart.prodamount = a;
        var n = a;
        void 0 !== window.tcart.prodamount_withdyndiscount && window.t_cart__discounts && window.t_cart__discounts.length > 0 && (n = window.tcart.prodamount_withdyndiscount), n = tcart__calcPromocode(n), "object" == typeof window.tcart.delivery && void 0 !== window.tcart.delivery.price && window.tcart.delivery.price > 0 && window.tcart.prodamount > 0 && (window.tcart.delivery.freedl > 0 && n >= window.tcart.delivery.freedl || (n += 1 * window.tcart.delivery.price)), n > 0 && (n = tcart__roundPrice(n)), window.tcart.amount = n
...
function tcart__reDrawCartIcon() {
    ...
    void 0 !== t.products && t.products.length > 0 && t.total > 0 ? (e && e.classList.add("t706__carticon_showed"), o && (o.innerHTML = t.total), Array.prototype.forEach.call(r, (function (e) {
        e.innerHTML = t.total
    }))) : (e && e.classList.remove("t706__carticon_showed"), o && (o.innerHTML = ""), Array.prototype.forEach.call(r, (function (t) {
        t.innerHTML = ""
    }))), t_onFuncLoad("t_posWidget__updateStyleWidget", (function () {
        t_posWidget__updateStyleWidget()
    })), o && ("" === tcart__showPrice(window.tcart.prodamount) ? a.style.display = "none" : (a.style.display = "block", a.innerHTML = "= " + tcart__showPrice(window.tcart.prodamount))), tcart__updateLazyload()
}
...
function tcart__openCart() {
    if (window.tcart_fullscreen) tcart__openCartSidebar();
        ...
        t && t.classList.remove("t706__carticon_showed"), t_triggerEvent(document.body, "popupShowed"), document.querySelector("body").classList.add("t706__body_cartwinshowed");
        var e = document.getElementById("customdelivery");
        (!e || e && !e.querySelector(".tcart__preloader")) && tcart__unblockSubmitButton(), tcart__form__hideErrors(), setTimeout((function () {
            tcart__lockScroll()
        }), 500), tcart__syncProductsObject__LStoObj(), tcart__updateProductsPrice();
        var r = document.querySelector(".t706__cartwin");
        r.style.display = "", r.style.opacity = 0, r.style.transition = "opacity .3s", r.classList.add("t706__cartwin_showed"), setTimeout((function () {
            r.style.opacity = 1, tcart__updateLazyload()
        }), 0), tcart__reDrawProducts(), tcart__reDrawTotal(), tcart__initAuthAndDelivery(), tcart__restoreFieldsFromLS(), document.addEventListener("keyup", tcart__keyUpFunc), tcart__onFuncLoad("t_forms__calculateInputsWidth", (function () {
...
function tcart__reDrawProducts() {
    ...
    if (window.tcart_fullscreen && (t = document.querySelector(".t706__sidebar-products"), e = document.querySelector(".t706__sidebar-content"), r = document.querySelector(".t706__sidebar-top"), document.body.classList.contains("t706__body_cartpageshowed") && (t = document.querySelector(".t706__cartpage-products"))), void 0 !== window.tcart.products) {
        var a = [],
        ...
        })), window.tcart.products = a, window.tcart.products.length !== n && tcart__saveLocalObj()
    }
    var c = "";
    if (a.length > 0 && Array.prototype.forEach.call(a, (function (t) {
        ...
        var d = "",
            s, u, l, _ = "white" === tcart__lumaRgb(getComputedStyle(e).backgroundColor || "rbg(255,255,255)") ? "filter:invert(100%);" : "";
        Array.prototype.forEach.call(a, (function (t, e) {
            if (d += '<div class="t706__product" data-cart-product-i="' + e + '">', "yes" == c && (d += '<div class="t706__product-thumb"><div class="t706__product-imgdiv"' + ("" !== t.img ? "style=\"background-image:url('" + t.img + "');\"" : "") + "></div></div>"), d += '<div class="t706__product-title t-descr t-descr_sm">', t.url ? d += '<a style="color: inherit" target="_blank" href="' + t.url + '">' + t.name + "</a>" : d += t.name, t.options && t.options.length > 0) {
                var r = {};
                for (var o in Array.prototype.forEach.call(t.options, (function (t) {
                    ...
                    })), d += '<div class="t706__product-title__option">', r) d += "<div>" + o + ": " + r[o] + "</div>";
                d += "</div>"
            }
            void 0 !== t.sku && "" != t.sku && (d += '<div class="t706__product-title__option">', d += t.sku, d += "</div>"), t.portion > 0 && (d += '<div class="t706__product-title__portion">', d += tcart__showPrice(t.price) + "/", "1" !== t.portion && (d += t.portion + " "), d += tcart_dict(t.unit) + "</div>"), d += "</div>", "y" == window.tcart_oneproduct ? d += '<div class="t706__product-plusminus t-descr t-descr_sm" style="display:none;"><span class="t706__product-quantity">' + t.quantity + "</span></div>" : (d += '<div class="t706__product-plusminus t-descr t-descr_sm"><span class="t706__product-minus"><img src="https://static.tildacdn.com/lib/linea/c8eecd27-9482-6c4f-7896-3eb09f6a1091/arrows_circle_minus.svg" style="width:16px;height:16px;border:0;' + _ + '"></span>', d += '<span class="t706__product-quantity">' + t.quantity + "</span>", d += '<span class="t706__product-plus"><img src="https://static.tildacdn.com/lib/linea/c47d1e0c-6880-dc39-ae34-521197f7fba7/arrows_circle_plus.svg" style="width:16px;height:16px;border:0;' + _ + '"></span></div>'), t.portion > 0 ? (d += '<div class="t706__product-amount--portion t-descr t-descr_sm">', t.amount > 0 && (d += '<span class="t706__product-amount">' + tcart__showPrice(t.amount) + "</span>", d += '<span class="t706__product-portion">' + tcart__showWeight(t.quantity * t.portion, t.unit) + "</span>"), d += "</div>") : (d += '<div class="t706__product-amount t-descr t-descr_sm">', t.amount > 0 && (d += tcart__showPrice(t.amount)), d += "</div>"), d += '<div class="t706__product-del-wrapper" style="display: table-cell; width: 20px; padding: 15px 0 15px 15px; vertical-align: middle;"><span class="t706__product-del"><img src="https://static.tildacdn.com/lib/linea/1bec3cd7-e9d1-2879-5880-19b597ef9f1a/arrows_circle_remove.svg" style="width:20px;height:20px;border:0;' + _ + '"></span></div>', d += "</div>"
        })), t.innerHTML = d, tcart__addEvents__forProducts(), tcart__unblockSubmitButton(), r.style.borderBottomWidth = "", o && (o.style.borderTopWidth = "")
    } else t.innerHTML = '<div class="t-name tn-name_xs t706__cartpage-products_empty">' + tcart_dict("empty") + "</div>", r.style.borderBottomWidth = "0", o && (o.style.borderTopWidth = "0")
}
...
function tcart__reDrawTotal() {
    var t = {
        ...
        e = "number" == typeof window.tcart.prodamount && "number" == typeof window.tcart.dyndiscount && window.tcart.prodamount === window.tcart.dyndiscount,
        r;
    window.tcart_fullscreen && (document.querySelector(".t706__sidebar-prodamount").innerHTML = tcart__showPrice(window.tcart.prodamount)), document.querySelector(".t706__cartwin-prodamount").innerHTML = tcart__showPrice(window.tcart.prodamount), document.querySelectorAll(".t706__cartwin-totalamount").forEach((function (t) {
    ...
    if ("object" == typeof window.tcart.delivery && window.tcart.delivery.name && void 0 !== window.tcart.delivery.price && (window.tcart.delivery.price > 0 || window.tcart.delivery["service-id"]))
        if (window.tcart.delivery.freedl > 0 && window.tcart.prodamount >= window.tcart.delivery.freedl && (window.tcart.prodamount_withdiscount >= window.tcart.delivery.freedl || !window.tcart.prodamount_withdiscount) && (window.tcart.prodamount_withdyndiscount >= window.tcart.delivery.freedl || !window.tcart.prodamount_withdyndiscount)) {
            a = !0;
            var i = "0";
            window.tcart.currency_txt_l && (i = window.tcart.currency_txt_l + " " + i), window.tcart.currency_txt_r && (i += " " + window.tcart.currency_txt_r.trim()), t.delivery.text = window.tcart.delivery.name, t.delivery.value = i
        } else window.tcart.delivery.price > 0 && (t.delivery.text = window.tcart.delivery.name, t.delivery.value = tcart__showPrice(window.tcart.delivery.price));
    if (Object.keys(t).forEach((function (e) {
            var r = t[e];
            if (r.text && r.value) {
                var n = '<span class="t706__cartwin-totalamount-info_label">' + r.text + ":</span>",
                    i = '<span class="t706__cartwin-totalamount-info_value" ' + (a ? 'title="' + tcart_dict("free") + '"' : "") + ">" + r.value + "</span>";
                o.forEach((function (t) {
                    t.insertAdjacentHTML("beforeend", n + i + "<br>")
                }))
            }
        })), window.tcart_fullscreen && !window.tcart_isMobile)(n = document.querySelector(".t706__cartpage-prodamount")).style.display = "none";
    ...
    0 == window.tcart.prodamount ? d.style.display = "none" : d.style.display = "block", tcart__changeSubmitStatus(), tcart__toggleTotalAmountVisibility(e);
    var s = document.querySelector(".t706__carticon-text"),
        u = "= " + tcart__showPrice(window.tcart.prodamount);
    !window.tcart_fullscreen && void 0 !== window.tcart.prodamount_withdyndiscount && window.t_cart__discounts && window.t_cart__discounts.length > 0 && (u = "= " + tcart__showPrice(window.tcart.prodamount_withdyndiscount, e ? "acceptzero" : "")), s && (s.innerHTML = u)
}

function tcart__toggleTotalAmountVisibility(t) {
    var e;
    document.querySelectorAll(".t706__cartwin-totalamount-wrap").forEach((function (e) {
        if (window.tcart_fullscreen && (window.innerWidth <= 960 ? e.style.display = "block" : e.style.display = "none"), window.tcart.prodamount != window.tcart.amount && (e.style.display = "block"), window.tcart_fullscreen || (e.style.display = "block"), window.tcart.promocode && (e.style.display = "block", 0 == window.tcart.amount && (document.querySelector(".t706__cartwin-totalamount").innerHTML = "0", window.tcart_fullscreen))) {
            var r = document.querySelector(".t706__cartpage-order-total-value");
            r && (r.innerHTML = "0")
        }
        window.tcart.delivery && window.tcart.delivery.price > 0 && (e.style.display = "block"), (t || window.tcart.dyndiscount) && (e.style.display = "block"), 0 === window.tcart.amount && window.tcart.prodamount === window.tcart.amount && (e.style.display = "none")
    }))
}
...
function tcart__changeSubmitStatus() {
    ...
    if (e && r) {
        if (e && (d >= window.tcart_minorder ? a() : n()), r && (window.tcart.total >= window.tcart_mincntorder ? i() : c()), d >= window.tcart_minorder && window.tcart.total >= window.tcart_mincntorder) {
        ...
        if (e)
            if (d >= window.tcart_minorder) {
                if (t && window.tcart.emptyDeliveryServices) return;
                (!o || o && !o.querySelector(".tcart__preloader")) && (a(), tcart__unblockSubmitButton())
            } else n();
        if (r)
    ...
    } else t && !window.tcart.emptyDeliveryServices && (window.tcart__errorHandler.hide(), (!o || o && !o.querySelector(".tcart__preloader")) && tcart__unblockSubmitButton())
}
...
function tcart__closeCart() {
    ...
    tcart__delZeroquantity_inCartObj(), document.removeEventListener("keyup", tcart__keyUpFunc), e && e.classList.remove("t706__carticon_neworder"), o.style.transition = "opacity .3s", o.style.opacity = 0, setTimeout((function () {
...
function tcart__restoreLostCart(t) {
    if (0 !== window.tcart.products.length) {
        ...
        var e = document.querySelector("#clear-cart-dialog"),
            ...
            a = function t() {
                t_triggerEvent(document.body, "popupHidden"), document.body.classList.remove("t-body_popupshowed"), null !== e.parentNode && e.parentNode.removeChild(e)
            };
        r.addEventListener("click", (function () {
            a(), tcart__openRestoredCart(t)
...
function tcart__getProductsInfoById(t) {
    ...
    i.onload = function () {
        if (i.readyState === i.DONE && 200 === i.status) {
            "string" == typeof i.responseText && "{" === i.responseText.substring(0, 1) || console.log("Can't get products array by uid list");
            try {
                ...
                if ("object" == typeof e && null !== e) {
                    ...
                    t.forEach((function (t) {
                        ...
                        if (a) {
                            var n = "";
                            if (a.gallery && (n = JSON.parse(a.gallery)), n.length) var i = JSON.parse(a.gallery)[0].img;
                            var c = a.editions,
                                d = c.map((function (t) {
                                    return t.uid
                                })).indexOf(parseInt(t.uid, 10)),
                                s = c[d];
                            s.gen_uid = t.gen_uid, s.name = t.name, s.quantity = t.quantity, s.options = t.options, s.amount = t.quantity * t.price, !s.img && i && (s.img = i), o.push(s)
                        }
                    })), tcart__restoreLostCart(o)
                } else console.log("Can't get products array by uid list")
            } catch (c) {
    ...
    }, i.open("POST", n), i.timeout = 2e4, i.send(o)
}
...
function tcart__fillRestoredCartForm(t) {
    ...
    var a = window.tcart_fullscreen ? ".t706__cartpage-form-wrapper  .t-form" : ".t706__orderform .t-form",
        ...
        i = n.querySelectorAll(".t-input, .t-checkbox");
    Array.prototype.forEach.call(i, (function (t) {
        var r = t.name;
        e[r] && (t.value = e[r]), "checkbox" === t.type && "yes" === e[r] && (t.checked = !0)
    }));
    var c = n.querySelector(".t-inputpromocode__wrapper");
    if (c) var d = c.querySelector(".t-inputpromocode");
    if (o && o.code && d && (d.value = o.code, c.querySelector(".t-inputpromocode__btn").style.display = "table-cell"), r) {
        var s = r["service-id"];
        if (!s) {
            var u = r.name,
                            ...
                            o, a = function t() {
                                ...
                                Array.prototype.forEach.call(a, (function (t) {
                                    ...
                                    if (r[o] && (t.value = r[o]), "pickup" == e) {
                                        ...
                                        a && n && p.showPickupInfo(a, n), n.querySelector(".searchbox-input").setAttribute("data-option-selected", !0)
                                    }
                                }))
                            };
                        t.removeEventListener("change", a), t.addEventListener("change", a), o && o.querySelectorAll('[data-service-id="' + s + '"]') ? a() : document.addEventListener("renderDeliveryAddresses", a)
                    }
                }))
            }
        }))
...
function tcart__showWrongOrderPopup() {
    if (!document.querySelector("#wrong-order-popup")) {
        ...
        document.querySelector("body").insertAdjacentHTML("beforeend", t), t_triggerEvent(document.body, "popupShowed"), document.body.classList.add("t-body_popupshowed");
...
function tcart__addLostCartStyles() {
    var t = "https://static.tildacdn.com/css/tilda-cart-restoreorder-1.0.min.css",
        e;
    if (!document.querySelector('link[href^="' + t + '"]')) {
        var r = document.createElement("link");
        r.setAttribute("rel", "stylesheet"), r.setAttribute("type", "text/css"), r.setAttribute("href", t), document.getElementsByTagName("head")[0].appendChild(r), document.querySelector("body").insertAdjacentElement("beforeend", r)
    }
}

function tcart__keyUpFunc(t) {
    27 == t.keyCode && (window.tcart_fullscreen ? tcart__closeCartSidebar() : tcart__closeCart(), document.body.classList.contains("t706__body_cartpageshowed") && tcart__closeCartFullscreen())
}
...
function tcart__blockSidebarContinueButton() {
    if (window.tcart_fullscreen) {
        ...
        window.tcart_isMobile && (t = document.querySelector(".t706 .t706__cartpage .t706__cartpage-open-form")), t && t.classList.add("t706__submit_disable")
    }
}
...
function tcart__unblockSidebarContinueButton() {
    if (window.tcart_fullscreen) {
        var t = document.querySelector(".t706 .t706__sidebar-continue");
        window.tcart_isMobile && (t = document.querySelector(".t706 .t706__cartpage .t706__cartpage-open-form")), t && t.classList.remove("t706__submit_disable")
    }
}
...
function tcart__product__del(t) {
    ...
    if (a > 136 || n) {
        ...
        var s = document.querySelector(d),
            u, l = s.querySelector('.t706__product-deleted[data-cart-product-i="' + r + '"]');
        if (!l) {
            e.insertAdjacentHTML("afterend", '<div class="t706__product-deleted" data-cart-product-i="' + r + '" style="display: none">                <div class="t706__product-deleted-wrapper" colspan="5">                    <div class="t706__product-deleted__timer t-descr">                        <div class="t706__product-deleted__timer__left">                            <div class="t706__product-deleted__timer__counter">                                <span class="t706__product-deleted__timer__counter__number">4</span>                                <svg class="t706__product-deleted__timer__counter__circle">                                    <circle r="10" cx="12" cy="12"></circle>                                </svg>                            </div>                            <div class="t706__product-deleted__timer__title">' + tcart_dict("youRemoved") + ' "' + i + '"</div>                        </div>                        <div class="t706__product-deleted__timer__return">' + tcart_dict("undo") + "</div>                    </div>                </div>            </div>"), l = s.querySelector('.t706__product-deleted[data-cart-product-i="' + r + '"]'), tcart_fadeOut(e, 200, (function () {
                null !== e.parentNode && (u = e.parentNode.removeChild(e)), tcart_fadeIn(l, 200), l.style.height = c + "px"
            ...
            if (0 === w) {
                ...
                window.tcart__preloader && t_delivery__dict && m && (m.style.display = "none", window.tcart__preloader.show(m, t_delivery__dict("loadingServices")))
            }
            var y = setInterval((function () {
                var t = l.querySelector(".t706__product-deleted__timer__counter__number"),
                    e = t.innerText,
                    o;
                window.tcart_fullscreen ? document.body.classList.contains("t706__body_cartsidebarshowed") ? o = !document.querySelector(".t706__sidebar").classList.contains("t706__sidebar_showed") : document.body.classList.contains("t706__body_cartpageshowed") && (o = !document.querySelector(".t706__cartpage").classList.contains("t706__cartpage_showed")) : o = !document.querySelector(".t706__cartwin").classList.contains("t706__cartwin_showed"), o && clearInterval(y), e > 1 ? t.innerText = parseInt(e, 10) - 1 : (clearInterval(y), tcart_fadeOut(l, 200, (function () {
                    var t;
                    "yes" !== l.getAttribute("data-clicked") && void 0 !== window.tcart.products[r] && "yes" === window.tcart.products[r].deleted && (null !== l.parentNode && l.parentNode.removeChild(l), window.tcart.products[r] = {}, 0 === s.querySelectorAll(".t706__product-deleted").length && tcart__isEmptyObject(window.tcart.products[r]) && (window.tcart.products.splice(r, 1), tcart__reDrawProducts()), tcart__saveLocalObj());
                    var e = window.tcart.products.filter((function (t) {
                        return !tcart__isEmptyObject(t)
                    })).length;
                    0 !== window.tcart.products.length && 0 !== e || (window.tcart_fullscreen ? (tcart__closeCartFullscreen(), tcart__closeCartSidebar()) : tcart__closeCart())
                })))
            }), 1e3);
            Array.prototype.forEach.call(l.querySelectorAll(".t706__product-deleted__timer__return"), (function (e) {
                var o = function o() {
                    if (l.setAttribute("data-clicked", "yes"), clearInterval(y), tcart_fadeOut(l, 200, (function () {
                            l.insertAdjacentElement("afterend", u), tcart_fadeIn(u, 200), null !== l.parentNode && l.parentNode.removeChild(l)
                    ...
                    t.classList.contains("t706__product-minus") ? tcart__product__plus(t) : (tcart__updateTotalProductsinCartObj(), tcart__reDrawCartIcon(), tcart__reDrawTotal(), tcart__saveLocalObj());
                    var n = document.getElementById("customdelivery");
                    (!n || n && !n.querySelector(".tcart__preloader")) && tcart__unblockSubmitButton(), e.removeEventListener("click", o)
                };
                e.addEventListener("click", o)
            }))
        }
    } else void 0 === window.tcart.products[r] && tcart__syncProductsObject__LStoObj(), window.tcart.products.splice(r, 1), null !== e.parentNode && e.parentNode.removeChild(e), tcart__updateTotalProductsinCartObj(), tcart__reDrawCartIcon(), tcart__saveLocalObj(), tcart__reDrawProducts(), tcart__reDrawTotal(), 0 === window.tcart.products.length && (window.tcart_fullscreen ? (tcart__closeCartFullscreen(), tcart__closeCartSidebar()) : tcart__closeCart())
}
...
function tcart__product__editquantity(t) {
    ...
    if (!t.querySelector(".t706__product-quantity-inp")) {
        ...
        t.innerHTML = n, t.classList.add("t706__product-quantity_editing");
        ...
        i.addEventListener("focus", (function () {
            ...
            tcart__product__updateQuantity(t, r, o, e = a > 0 ? a : 1), t.textContent = window.tcart.products[o].quantity, t.classList.remove("t706__product-quantity_editing")
        }))
    }
}
...
function tcart__processDelivery(t) {
    ...
    var r = e.split("=")[0].trim(),
        o, a = tcart__cleanPrice(t.getAttribute("data-delivery-price") || 0);
    ...
    if (n) {
        var i = n.getAttribute("data-service-id");
...
function tcart__setFreeDeliveryThreshold() {
    if (window.tcart_newDeliveryActive && window.tcart_newDelivery.deliveryState.freeDeliveryThreshold >= 0) window.tcart.delivery.freedl = window.tcart_newDelivery.deliveryState.freeDeliveryThreshold;
    else {
    ...
    if (0 != document.querySelectorAll(".t706 .t-input-group_pm").length) {
        ...
        if (t.length) {
            Array.prototype.forEach.call(t, (function (t) {
                t.addEventListener("change", (function () {
                    var t, e;
                    document.querySelector(".t706 .t-form .t-radio__wrapper-payment input:checked") && (e = document.querySelector(".t706 .t-form .t-radio__wrapper-payment input:checked").getAttribute("data-payment-variant-system")), e || (e = ""), document.querySelector(".t706").setAttribute("data-payment-variant-system", e), window.tcart.system = e
                }))
            }));
...
function tcart__cleanPrice(t) {
    return t ? (t = (t = t.replace(",", ".")).replace(/[^0-9\.]/g, ""), t = parseFloat(t).toFixed(2), isNaN(t) && (t = 0), t = parseFloat(t), (t *= 1) < 0 && (t = 0)) : t = 0, t
}

function tcart__roundPrice(t) {
    return void 0 === t || "" == t || 0 == t ? t = 0 : (t = parseFloat(t).toFixed(2), t = parseFloat(t), (t *= 1) < 0 && (t = 0)), t
}
...
function tcart__showWeight(t, e) {
    ...
    if (Object.keys(r).forEach((function (t) {
        ...
        for (var n = r[a].value, i = null !== n && "object" == typeof n, c = o + 1; c < r[a].units.length; c++) i && (n = n[c]), t > n && (t /= n, e = r[a].units[c]);
...
function tcart__lockScroll() {
    if (window.t_cart__isiOS && 11 === window.t_cart__iOSMajorVersion && !window.MSStream && !document.body.classList.contains("t-body_scroll-locked")) {
        ...
        document.body.classList.add("t-body_scroll-locked"), document.body.style.top = "-" + t + "px", document.body.setAttribute("data-popup-scrolltop", t)
    }
}
...
function tcart__unlockScroll() {
    if (window.t_cart__isiOS && 11 === window.t_cart__iOSMajorVersion && !window.MSStream && !document.body.classList.contains("t-body_scroll-locked")) {
        ...
        document.body.classList.remove("t-body_scroll-locked"), document.body.style.top = "", document.body.removeAttribute("data-popup-scrolltop"), window.scrollTo(0, t)
    }
}
...
function tcart__clearProdUrl() {
    var t = window.location.href,
        ...
        e;
    if (window.isiOS && e < 0 && (e = t.indexOf("%23!/tproduct/")) < 0 && (e = t.indexOf("#%21%2Ftproduct%2F")), e > -1) try {
        window.history.replaceState("", "", t.substring(0, e))
    } catch (o) {}
...
function tcart__onFuncLoad(t, e, r) {
    if ("function" == typeof window[t]) e();
        ...
        setTimeout((function a() {
            var i = Date.now();
            "function" != typeof window[t] ? ("complete" === document.readyState && i - o > 5e3 && "function" != typeof window[t] && n(), setTimeout(a, r || 100)) : e()
        }))
    }
}
...
function tcart_fadeOut(t, e, r) {
    ...
    var a, n = setInterval((function () {
        t.style.opacity = o, (o -= .1) <= .1 && (clearInterval(n), t.style.display = "none", "function" == typeof r && r())
    }), e > 0 ? e / 10 : 40)
}
...
function tcart_fadeIn(t, e, r) {
    ...
    var n = setInterval((function () {
        t.style.opacity = o, (o += .1) >= 1 && (clearInterval(n), "function" == typeof r && r())
    }), a)
}
...
function tcart__openCartFullscreen() {
    ...
    if (t.style.display = "", window.tcart_isMobile) {
        ...
        r.style.display = "block", e.style.display = "none", "none" === o.style.display && (o.style.display = "block"), o.addEventListener("click", (function () {
            e.style.display = "block", e.style.opacity = 0, e.style.transform = "translateY(75%)", e.style.transition = "opacity .1s, transform .1s", setTimeout((function () {
    ...
    t.style.opacity = 0, t.style.transition = "opacity .3s", t.classList.add("t706__cartpage_showed"), setTimeout((function () {
        t.style.opacity = 1, tcart__updateLazyload()
    }), 0), tcart__syncProductsObject__LStoObj(), tcart__updateProductsPrice(), tcart__reDrawProducts(), tcart__reDrawTotal(), tcart__initAuthAndDelivery(), tcart__restoreFieldsFromLS(), document.addEventListener("keyup", tcart__keyUpFunc), 0 === window.tcart.products.length ? tcart__blockSidebarContinueButton() : tcart__unblockSidebarContinueButton(), t_triggerEvent(document, "fullscreenCartOpened"), tcart__onFuncLoad("t_forms__calculateInputsWidth", (function () {
        t_forms__calculateInputsWidth()
    }))
}
...
function tcart__openCartSidebar() {
    if (window.tcart_isMobile) tcart__openCartFullscreen();
        ...
        t_triggerEvent(document.body, "popupShowed"), document.querySelector("body").classList.add("t706__body_cartsidebarshowed"), tcart__syncProductsObject__LStoObj(), tcart__updateProductsPrice();
        var t = document.querySelector(".t706__sidebar"),
            e = document.querySelector(".t706__sidebar-content");
        t.style.display = "", t.style.opacity = 0, t.style.transition = "opacity .3s", t.classList.add("t706__sidebar_showed"), setTimeout((function () {
            e.scrollTop = 0, t.style.opacity = 1, e.classList.add("t706__sidebar-content_showed"), tcart__updateLazyload()
        })), tcart__syncProductsObject__LStoObj(), tcart__updateProductsPrice(), tcart__reDrawProducts(), tcart__reDrawTotal(), document.addEventListener("keyup", tcart__keyUpFunc), 0 === window.tcart.products.length ? tcart__blockSidebarContinueButton() : tcart__unblockSidebarContinueButton()
    }
}
...
function tcart__initDelivery() {
    Array.prototype.forEach.call(document.querySelectorAll(".t706 .t-form .t-radio__wrapper-delivery"), (function (t) {
        if ("y" === t.getAttribute("data-delivery-services") && !window.tcart_newDeliveryActive)
            if ("undefined" != typeof tcart_newDelivery && "function" == typeof tcart_newDelivery.init) tcart_newDelivery.init(window.tcart__ymapApiKey);
            else {
                var e = "https://static.tildacdn.com/js/tilda-delivery-1.0.min.js";
                if (!document.querySelector('script[src^="' + e + '"]')) {
                    var r = document.createElement("script");
                    r.type = "text/javascript", r.src = e, r.onload = function () {
                        tcart_newDelivery.init(window.tcart__ymapApiKey);
                        var t = "https://static.tildacdn.com/css/tilda-delivery-1.0.min.css",
                            e;
...
function tcart__restoreFieldsFromLS() {
    if (document.querySelectorAll(".t706 .t-form .t-input-group_sf").length > 0) {
        var t = "https://static.tildacdn.com/js/tilda-cart-restorefields-1.0.min.js";
    ...
    if (!("edit" === document.getElementById("allrecords").getAttribute("data-tilda-mode"))) {
        ...
        try {
            var o = JSON.parse(localStorage.getItem("tcart_discounts")),
                ...
                i = o && o.discounts;
            i && 0 !== i.length && Date.now() - n < 9e5 && (window.t_cart__discounts = i, window.sumpromowithdiscount = a, tcart__insertDiscountsScript(), r = !1), i && 0 === i.length && Date.now() - n < 9e5 && (window.t_cart__discounts = i, window.sumpromowithdiscount = a, r = !1)
        } catch (d) {
...
function tcart__sendDiscountsRequest(t, e) {
    var r = new XMLHttpRequest,
        ...
        a = "projectid=" + t;
    r.open("POST", o, !0), r.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), r.onreadystatechange = function () {
        if (4 == r.readyState && 200 == r.status) {
            var t = JSON.parse(r.responseText);
            if (!Array.isArray(t) && t.sumpromowithdiscount && t.discounts ? (window.t_cart__discounts = t.discounts, window.sumpromowithdiscount = t.sumpromowithdiscount) : window.t_cart__discounts = t, Array.isArray(window.t_cart__discounts)) {
                if (0 !== window.t_cart__discounts.length && tcart__insertDiscountsScript(), "object" == typeof localStorage) try {
                    var e = {
                        time: Date.now(),
                        discounts: window.t_cart__discounts
                    };
                    window.sumpromowithdiscount && localStorage.setItem("tcart_discounts_sumrule", JSON.stringify(window.sumpromowithdiscount)), localStorage.setItem("tcart_discounts", JSON.stringify(e))
                } catch (o) {
                    console.error("Your web browser does not support storing a Discount data locally.")
                }
                return
        ...
        if (t && (t.status >= 500 || 408 == t.status || 410 == t.status || 429 == t.status || "timeout" === t.type)) "function" == typeof e && setTimeout((function () {
            e()
        }), 5e3);
        else {
            var r = "";
            r = t && t.responseText > "" ? "[" + t.status + "] " + t.responseText : t && t.statusText ? "Error [" + t.status + ", " + t.statusText + "]" : "Error type [" + t.type + "]", console.log(r + ". Please, try again later.")
        }
    }, r.timeout = 2e4, r.send(a)
}

function tcart__insertDiscountsScript() {
    var t = "tilda-cart-discounts-1.0";
    if (document.getElementById("cart_discounts_script")) tcart__onFuncLoad("tcart__calcAmountWithDiscounts", (function () {
        tcart__calcAmountWithDiscounts()
    }));
    else {
        var e = document.createElement("script");
        e.id = "cart_discounts_script", e.type = "text/javascript", e.src = "https://static.tildacdn.com/js/" + t + ".min.js", e.onload = function () {
            console.log("executing discounts"), tcart__calcAmountWithDiscounts()
        }, e.onerror = function () {
            console.error("Failed to load tilda-cart-discounts: ", this.src)
        }, document.head.appendChild(e);
        var r = document.createElement("link");
        r.id = "cart_discounts_style", r.rel = "stylesheet", r.href = "https://static.tildacdn.com/css/" + t + ".min.css", document.head.appendChild(r)
    }
}
...
function tcart__calcPromocode(t) {
    if ("object" != typeof window.tcart.promocode) return delete window.tcart.prodamount_discountsum, delete window.tcart.prodamount_withdiscount, t;
    if (!(window.tcart.promocode.discountsum > 0 || window.tcart.promocode.discountpercent > 0)) return console.error("Cart Some error."), t;
    var e = 0,
        r = 0,
        o = !1,
        a = window.tcart.prodamount;
    if (window.t_cart__discounts && window.t_cart__discounts.length > 0 && void 0 !== window.tcart.prodamount_withdyndiscount && (a = window.tcart.prodamount_withdyndiscount), window.tcart.products.forEach((function (t) {
            if ("yes" !== t.deleted && 0 !== Object.keys(t).length) {
                ...
                if (window.t_cart__discounts && window.t_cart__discounts.length > 0 && void 0 !== t.amount_withdiscount && (i = t.price_withdiscount, c = t.amount_withdiscount), t.portion && (i /= s, d = !0, window.showdiscountdata && console.log("start price for one portion (" + t.portion + ") - " + i)), window.tcart.promocode.discountsum > 0) n = tcart_ceil(i * (1 - window.tcart.promocode.discountsum / a));
                else if (window.tcart.promocode.discountpercent > 0) {
                    var u;
                    n = tcart_ceil(i * (1 - window.tcart.promocode.discountpercent / 100))
                }
                1 * t.quantity != 1 || t.portion || (o = !0), d && (window.showdiscountdata && console.log("For one portion: " + i + " -> " + n), n = tcart_ceil(n * s));
                var l = tcart_ceil(n * t.quantity);
                e += tcart_ceil(c - l), r = tcart_ceil(1 * r + l), window.showdiscountdata && console.log((d ? i * t.portion : i) + " -> " + n + " = " + e)
            }
        })), e = tcart_ceil(e), window.tcart.promocode.discountsum > 0) {
        var n = 1 * window.tcart.promocode.discountsum - 1 * e;
        window.showdiscountdata && console.log(window.tcart.promocode.discountsum, e, n), o && n > 0 && (r = tcart_ceil(t - window.tcart.promocode.discountsum), e = window.tcart.promocode.discountsum)
    }
    r < 0 && (r = 0), window.tcart.prodamount_discountsum = e, window.tcart.prodamount_withdiscount = r, window.tcart.promocode.prodamount_discountsum = e;
...
function tcart__showBubble(t) {
    ...
    if ("yes" !== document.querySelector(".t706").getAttribute("data-opencart-onorder")) {
        if (!document.querySelector(".t706__bubble-container")) {
            ...
            a.className = "t706__bubble-container", document.body.appendChild(a)
        }
        var n = document.querySelector(".t706__bubble-container"),
            i = n.querySelectorAll(".t706__bubble.t706__bubble_visible"),
            c;
        if (i.length >= 4) tcart__closeBubble(i[0]);
        var d = document.createElement("div");
        d.className = "t706__bubble t706__bubble_visible", d.innerHTML = '\n\t\t<div class="t706__bubble-close">&times;</div>\n\t\t<div class="t706__bubble-text t-descr"></div>\n\t', d.querySelector(".t706__bubble-text").textContent = tcart__decodeHtml(t), d.querySelector(".t706__bubble-close").addEventListener("click", (function () {
...
function tcart__closeBubble(t) {
    if (t) {
        var e = t.dataset.id;
        clearTimeout(e), t.classList.remove("t706__bubble_visible"), t.classList.add("t706__bubble_hidden"), t.addEventListener("animationend", (function () {
            t.remove()
        }), {
            once: !0
        })
        ...
        o.onload = function () {
            if (o.readyState === o.DONE)
                if (200 === o.status) try {
                    ...
                    console.log("Error parsing JSON:", '"' + o.responseText + '"'), r(new Error(a))
                } else r(new Error("Network response was not ok"))
        }, o.ontimeout = o.onerror = function (t) {
            console.log("Timeout or error fetching order details", t), r(new Error("Network error"))
        }, o.open(i, t, !0), o.timeout = 3e4, o.send()
    }))
}
...
function t706_onSuccessCallback() {
    ...
    t && t706_slideUp(t, 10), e && t706_slideUp(e, 10), r && t706_slideUp(r, 700);
    try {
        tcart__unlockScroll()
    } catch (o) {}
}
...
function t706_slideUp(t, e) {
    t && (e || 0 === e || (e = 500), t.style.transitionProperty = "height, margin, padding", t.style.transitionDuration = e + "ms", t.style.boxSizing = "border-box", t.style.height = t.offsetHeight + "px", t.style.overflow = "hidden", t.style.height = "0", t.style.paddingTop = "0", t.style.paddingBottom = "0", t.style.marginTop = "0", t.style.marginBottom = "0", setTimeout((function () {
        t.style.display = "none", t.style.height = "", t.style.paddingTop = "", t.style.paddingBottom = "", t.style.marginTop = "", t.style.marginBottom = "", t.style.overflow = "", t.style.transitionDuration = "", t.style.transitionProperty = ""
    }), e))
}
...
window.t_cart__browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tcart_endpoint = "store.tildacdn.com", t_onReady((function () {
    var t = document.getElementById("allrecords");
    if (t) {
